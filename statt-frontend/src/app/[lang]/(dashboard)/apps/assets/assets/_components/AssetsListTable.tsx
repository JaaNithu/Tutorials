...
const AssetsListTable = ({ tableData }: { tableData?: UsersType[] }) => {
  // States
  ...
  return (
    <>
      <Card>
        <CardHeader title='Assets Data Table' className='pbe-4' />
        <Divider></Divider>
      ...
      <AddNewAsset open={addUserOpen} handleClose={() => setAddUserOpen(!addUserOpen)} />
    </>
  )
}
