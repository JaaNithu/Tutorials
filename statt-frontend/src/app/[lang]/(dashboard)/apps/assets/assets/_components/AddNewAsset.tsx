...
const AddNewAsset = ({ open, handleClose }: Props) => {
  // States
  ...
  return (
    ...
    >
      <div className='flex items-center justify-between pli-5 plb-4'>
        <Typography variant='h5'>Add New Asset</Typography>
      ...
      <div className='p-5'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
          ...
          <FormControl fullWidth>
            <InputLabel id='country'>Asset Type</InputLabel>
            <Select
              fullWidth
              id='country'
            ...
            >
              <MenuItem value='UK'>Chair</MenuItem>
              <MenuItem value='USA'>Table</MenuItem>
              <MenuItem value='Australia'>Cupboard</MenuItem>
              <MenuItem value='Germany'>Vehicle</MenuItem>
            </Select>
          </FormControl>
          <FormControl fullWidth>
